...
if(is_numeric($url[1])):
	...
	$autor = $autorNeg->listar('p.id_post='.$postId->id_post,'i.nome','relaciona');
...
<html class="no-<?php echo ROOT?>js/" lang="en">
  ...
  <body>
   ...
   <div class="row collapse">
  		...
  		<div id="whatsapp" class="show-for-small-only"><a href="whatsapp://send?text=Saca essa: <?php echo urlencode($url_pg)?>" rel="nofollow" onclick="ga('send', 'event', 'link','click', 'whatsapp');">Espalhe por Whatsapp</a></div>  		
        ...
        <?php if(is_numeric($url[1])):?>
							...
							foreach($autor as $au):
								...
								if($au->imagem!=''):
									echo '<img src="'.URL.'data/avatar/'.$au->imagem.'" alt="'.$au->nome.'" style="width:90px; margin-bottom:15px;"/><br>';
								endif;
								echo $au->nome.'</span>';
							endforeach;
							?>
                            <!--<span class="autor">
							<?php echo $data_completa?>
							</span>-->
                        	...
                        	<div class="row collapse">
                            	...
                            	<div class="small-12 medium-4 columns">
                                	<ul class="share">
                                        ...
                                        <li class="show-for-small-only"><a href="whatsapp://send?text=Leia: <?php echo urlencode($url_pg)?>" rel="nofollow"><img src="<?php echo ROOT?>img/ico-whatsapp-share.png" alt="Compartilhe por Whatsapp" /></a></li>
                                    </ul>
                                </div>                                
                            </div>
                        </div>
		...
		<?php endif;?>						
            ...
            <div class="bloco-3">
				...
				<div class="row">
					...
					$autor = $autorNeg->listar('id_post='.$p->id_post,'i.nome','relaciona');
					?>
