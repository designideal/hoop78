                        ...
                        <div id="facebook">
							<div class="row">
								<div class="small-12 columns text-center">
									...
									<div class="fb-like" data-href="http://www.facebook.com/hoop78" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>	
                    		 	</div>	
                     		 </div>
                       </div>
		...
		<?php endif;?>						
            ...
            <div class="bloco-3">
				...
				<div class="row">
					...
					?>
                    <div class="medium-4 columns <?php echo (is_numeric($url[1]))?'':'bottom30'?> end">
                    	<div class="pad">
