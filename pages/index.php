   ...
   <div class="row collapse">
   		<div class="medium-12 columns text-center" style="position:relative;">
            <div id="quote">
				...
				<div class="row">
				<div class="medium-12 medium-centered columns"><p><?php echo $aspas[0]->texto?></p></div>
				</div>
            </div>
		</div>
   </div>
   ...
   <div class="row collapse">
   		<div id="conteudo">
			...
			for($b=0;3>$b;$b++):
				...
				$autor_bl3 = $autorNeg->listar('id_post='.$bloco3[$b]->id_post,'i.nome','relaciona');
			?>
                    ...
                    <div class="medium-4 columns">
                    	<div class="pad">
                        	<a href="<?php echo URL.$bloco3[$b]->categoria_slug.'/'.$funcao->dataBr($bloco3[$b]->data).'/'.$bloco3[$b]->slug?>">
                                ...
                                <span class="autor">
								<!--<?php echo $data_bl3?> --> Por 
								<?php
								$a=0;
								foreach($autor_bl3 as $au):
									$ai=$a++;
									$separa=((count($autor_bl3)-1)==$ai)?'':' / ';
									echo $au->nome.$separa;
								endforeach;
								?>
								</span>
             ...
             <div class="bloco-2">   
             	<div class="row">
					...
					foreach($bloco2 as $bl2):
						...
						$autor_bl2 = $autorNeg->listar('id_post='.$bl2->id_post,'i.nome','relaciona');
					?>
                    <div class="medium-6 columns">
                    	<div class="pad">
                        	<a href="#">
                                ...
                                <span class="autor">
								<!--<?php echo $data_bl2?>--> Por  
								<?php
								$a=0;
								foreach($autor_bl2 as $au):
									$ai=$a++;
									$separa=((count($autor_bl2)-1)==$ai)?'':' / ';
									echo $au->nome.$separa;
								endforeach;
								?>
								</span>
